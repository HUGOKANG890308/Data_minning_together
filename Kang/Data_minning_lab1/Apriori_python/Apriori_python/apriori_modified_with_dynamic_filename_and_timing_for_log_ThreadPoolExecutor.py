...
def printResults(items):
    ...
    with open("C:\\Users\\User\\OneDrive\\資料探勘_交大\\Data_minning_lab1\\apriori_log_ThreadPoolExecutor.txt", "a") as f:
        f.write("---\nFrequent Itemsets\n---\n")
...
if __name__ == "__main__":
    ...
    #     default="C:\\Users\\User\\OneDrive\\資料探勘_交大\\Data_minning_lab1\\apriori_log_ThreadPoolExecutor.txt",
    #     type="str",
    # )
    ...
    with open("C:\\Users\\User\\OneDrive\\資料探勘_交大\\Data_minning_lab1\\apriori_log_ThreadPoolExecutor.txt", "a") as f:
        f.write(f"--------- {filename}: {minimum_support}---------")
