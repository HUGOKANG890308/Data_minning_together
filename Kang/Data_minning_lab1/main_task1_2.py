...
import time
import os
os.chdir('C:\\Users\\User\\Desktop\\Data_minning_together\\Kang\\Data_minning_lab1')
# 指定檔案名和其它靜態參數
    ...
    for f in filenames:
        ...
        for s in support_values:
            ...
            if time1 and time2:
                ...
                with open(f"result\\Result_file_for_Task3.txt", "w") as f1:
