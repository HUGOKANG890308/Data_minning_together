...
def printResults(items):
    global total_frequent_itemsets_task1
    with open(f"output_in_step2\\task1\\Result_file1\\step2_task1_{filename}_{minSupport_task1}_result1.txt", "w") as f1, open(f"output_in_step2\\task1\\Result_file2\\step2_task1_{filename}_{minSupport_task1}_result2.txt", "w") as f2:
